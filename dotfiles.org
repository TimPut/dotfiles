...
main = do
  ...
  xmonad $ defaults {
      ...
      , startupHook = setWMName "LG3D" --Fixes graphical glitches in some Java programs
  }
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (shm rainbow-mode rainbow-delimiters py-autopep8 powerline org-wc org-time-budgets org-ref org-pomodoro org-plus-contrib org-pdfview org-bullets org-beautify-theme org-ac multiple-cursors move-text mmm-mode material-theme magithub magit highlight-current-line haskell-mode flyspell-correct-popup flycheck elpy ein djvu diffview company-statistics company-quickhelp company-math company better-defaults auctex which-key use-package ac-math ac-ispell)))
