...
Config {
--    font = "xft:Fixed-8",
    font = "xft:Hack-12:antialias=true,Fixed-12",
    bgColor = "#000000",
    fgColor = "#ffffff",
    ...
    lowerOnStart = True,
    commands = [
        Run Weather "CYEG" ["-t","<tempC>C <skyCondition> RH:<rh>% <pressure>hPa","-L","64","-H","77","-n","#CEFFAC","-h","#FFB6B0","-l","#96CBFE"] 36000
    ...
    sepChar = "%",
    alignSep = "}{",
    template = "%StdinReader% }{ %multicpu%  %memory%  %battery% <fc=#FFFFCC>%date%</fc> %CYEG% "
    }
